...
function readStoredOptions(env) {
  ...
  for (const configPath of configPaths) {
    try {
      ...
      const pluginId = configuredPluginId && optionEntries[configuredPluginId] ? configuredPluginId : Object.keys(optionEntries).find(
        (key) => key.startsWith("langfuse-observability@")
      );
...
var SDK_INTEGRATION = "zcode-langfuse-observability";
